...
### **2.1 การจัดการเครือข่ายและการเชื่อมต่อ**
- **fifQB5xNlEkpHGCAPl4DuR**  
  ▸ ฟังก์ชัน: สแกนหาหุ่นยนต์ UR ในเครือข่ายเดียวกัน  
  ▸ พารามิเตอร์: `ip` (IP ในเครือข่ายเดียวกัน)

- **fE5gA9T733lcQ8Hd_MLP82**  
  ▸ ฟังก์ชัน: เชื่อมต่อกับหุ่นยนต์ UR  
  ▸ พารามิเตอร์: `ip` (IP หุ่นยนต์)

- **fsX43cYxV0PI4evuVyUBQb**  
  ▸ ฟังก์ชัน: ตัดการเชื่อมต่อกับหุ่นยนต์ UR  
  ▸ พารามิเตอร์: `ip` (IP หุ่นยนต์)

---

### **2.2 การตรวจสอบสถานะหุ่นยนต์**
- **fOIkmMPGlGGxwyw-3P9PLw**  
  ▸ ฟังก์ชัน: รับเวลาการทำงาน  
  ▸ พารามิเตอร์: `ip`

- **fwyyKaqkrt6NBWXlSqhla2**  
  ▸ ฟังก์ชัน: รับหมายเลขซีเรียล  
  ▸ พารามิเตอร์: `ip`

- **f6sWepY5YsPIqDuVllQixz**  
  ▸ ฟังก์ชัน: รับเวอร์ชันซอฟต์แวร์  
  ▸ พารามิเตอร์: `ip`

- **fJmgMj32RjjCxzg3n-OmKs**  
  ▸ ฟังก์ชัน: รับโหมดความปลอดภัย  
  ▸ พารามิเตอร์: `ip`

- **fAJNyeIvDxM49kypgXs9xx**  
  ▸ ฟังก์ชัน: รับสถานะการทำงาน  
  ▸ พารามิเตอร์: `ip`

- **frXKuqREVTmRygel-MDG11**  
  ▸ ฟังก์ชัน: รับสถานะการทำงานโปรแกรม  
  ▸ พารามิเตอร์: `ip`

---

### **2.3 การอ่านข้อมูลและรีจิสเตอร์**
- **fOXjbOy_B40SqwczE0zRRx**  
  ▸ ฟังก์ชัน: อ่านรีจิสเตอร์ Int (0~23)  
  ▸ พารามิเตอร์: `ip`, `index` (0-23)

- **ftWfHugqIFU3zE1k4szoST**  
  ▸ ฟังก์ชัน: อ่านรีจิสเตอร์ Double (0~23)  
  ▸ พารามิเตอร์: `ip`, `index` (0-23)

- **f-CXiO_NaDsWiwltfrDhks**  
  ▸ ฟังก์ชัน: อ่านรีจิสเตอร์ Double (0~31)  
  ▸ พารามิเตอร์: `ip`, `index` (0-31)

---

### **2.4 การควบคุมการเคลื่อนไหว**
- **fq5lK3nuHMu6AR1AOolkVT**  
  ▸ ฟังก์ชัน: การเคลื่อนไหวในพื้นที่ข้อต่อ  
  ▸ พารามิเตอร์: `ip`, `q` (มุมข้อต่อ), `a`/`v`/`t`/`r` (ไม่บังคับ)

- **fepruq4N7v4MBNqsiIvLRc**  
  ▸ ฟังก์ชัน: การเคลื่อนไหวเส้นตรง TCP  
  ▸ พารามิเตอร์: `ip`, `pose` (ตำแหน่ง TCP), `a`/`v`/`t`/`r` (ไม่บังคับ)

- **fcKCrZ2H_lwnAe4P2uTJ4L**  
  ▸ ฟังก์ชัน: การเคลื่อนไหวเส้นตรงตามแกน X  
  ▸ พารามิเตอร์: `ip`, `distance` (เมตร)

- **f77gv6fXQGTSKbsgemu8Np**  
  ▸ ฟังก์ชัน: การเคลื่อนไหวเส้นตรงตามแกน Y  
  ▸ พารามิเตอร์: `ip`, `distance`

- **f-bIJDZENUgzPrLJqOFvIs**  
  ▸ ฟังก์ชัน: การเคลื่อนไหวเส้นตรงตามแกน Z  
  ▸ พารามิเตอร์: `ip`, `distance`

---

### **2.5 การจัดการโปรแกรม**
- **ftdgwJLZQ2dYp2mB1ZtRPD**  
  ▸ ฟังก์ชัน: โหลดโปรแกรม  
  ▸ พารามิเตอร์: `ip`, `program_name`

- **fl1XHdiQ-GgEJPB7rlMaHU**  
  ▸ ฟังก์ชัน: โหลดและรันโปรแกรม  
  ▸ พารามิเตอร์: `ip`, `program_name`

- **fL8CYEkias2SbMtv0S7s-N**  
  ▸ ฟังก์ชัน: หยุดโปรแกรมปัจจุบัน  
  ▸ พารามิเตอร์: `ip`

- **fkS98Mpak4obl30wTves1K**  
  ▸ ฟังก์ชัน: ระงับโปรแกรมปัจจุบัน  
  ▸ พารามิเตอร์: `ip`

- **fV_tezoVRKYr9IiYnl2ezU**  
  ▸ ฟังก์ชัน: ส่งสคริปต์โปรแกรม  
  ▸ พารามิเตอร์: `ip`, `script`

---

### **2.6 เซนเซอร์และการตรวจสอบพลังงาน**
- **fW18vf-tvLsFR-8coc2e5U**  
  ▸ ฟังก์ชัน: รับแรงดันไฟฟ้าปัจจุบัน  
  ▸ พารามิเตอร์: `ip`

- **fEK48x3yHMxEx14KQsVzjZ**  
  ▸ ฟังก์ชัน: รับกระแสไฟฟ้าปัจจุบัน  
  ▸ พารามิเตอร์: `ip`

- **fEh1yfbkyrh-kr2PDF7XI5**  
  ▸ ฟังก์ชัน: รับแรงดันไฟฟ้าข้อต่อ  
  ▸ พารามิเตอร์: `ip`

- **fsmxaF8Agn8NF0mMegv3_f**  
  ▸ ฟังก์ชัน: รับกระแสไฟฟ้าข้อต่อ  
  ▸ พารามิเตอร์: `ip`

- **fdGsS6kwiGlY_zybhYQWrS**  
  ▸ ฟังก์ชัน: รับอุณหภูมิข้อต่อ  
  ▸ พารามิเตอร์: `ip`
...
- **f6danXc2Pz98ilo5gMNc44**  
  ▸ ฟังก์ชัน: รับพิกัด TCP แบบเรียลไทม์  
  ▸ พารามิเตอร์: `ip`

- **fwHgxwtA4blZuetfmJ3OiK**  
  ▸ ฟังก์ชัน: รับมุมข้อต่อแบบเรียลไทม์  
  ▸ พารามิเตอร์: `ip`
