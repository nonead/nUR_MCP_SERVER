...
| ID เครื่องมือ (nUR_MCP_SERVER) | หมวดหมู่          | คำอธิบาย                          | พารามิเตอร์          |  
|--------------------------------|------------------|----------------------------------|---------------------|  
| ffWzqSZlUpjFfVITKvBb-b         | การจัดการการเชื่อมต่อ | เชื่อมต่อกับหุ่นยนต์ UR          | `ip`: IP หุ่นยนต์  |  
| fx5l9Mb_BUs_hClarGKZIo         | การจัดการการเชื่อมต่อ | ตัดการเชื่อมต่อหุ่นยนต์ UR       | `ip`: IP หุ่นยนต์  |  
| f04vj-Fwbuo8s2oYu252pR         | การตรวจสอบสถานะ    | รับเวลาการทำงานของหุ่นยนต์       | `ip`: IP หุ่นยนต์  |  
| f2SHZtIYF_OhS8LuslKt8D         | การทำงานกับรีจิสเตอร์ | อ่านค่าของรีจิสเตอร์ Int (0-23) | `ip`: IP หุ่นยนต์, `index`: ดัชนีรีจิสเตอร์ (0-23) |  
| fjLf_89qRxYDlEKo_oXADQ         | การทำงานกับรีจิสเตอร์ | อ่านค่าของรีจิสเตอร์ Double (0-23) | `ip`: IP หุ่นยนต์, `index`: ดัชนีรีจิสเตอร์ (0-23) |  
| f9uXSEQB1UZMXmgIyPtVH9         | การทำงานกับรีจิสเตอร์ | อ่านค่าของรีจิสเตอร์ Double (0-31) | `ip`: IP หุ่นยนต์, `index`: ดัชนีรีจิสเตอร์ (0-31) |  
| fBHQbdS9p_BPv97XBAau8a         | ข้อมูลอุปกรณ์      | รับหมายเลขซีเรียลของหุ่นยนต์     | `ip`: IP หุ่นยนต์  |  
| fcHIfX-J83SvH0V6XZ59A7         | การควบคุมการเคลื่อนไหว | รับพิกัด TCP แบบเรียลไทม์       | `ip`: IP หุ่นยนต์  |  
| fwloSfxAGiC_4rjdaZjUng         | การควบคุมการเคลื่อนไหว | รับมุมข้อต่อแบบเรียลไทม์        | `ip`: IP หุ่นยนต์  |  
| fFg2TP6jf3XTWytLIf9fyO         | การควบคุมการเคลื่อนไหว | ส่งคำสั่งท่าทางข้อต่อ           | `ip`: IP หุ่นยนต์, `q`: มุมข้อต่อ (เรเดียน), `a/v/t/r`: พารามิเตอร์การเคลื่อนไหว |  
| fBevTU5BWNdVNEKgqLV5d1         | การควบคุมการเคลื่อนไหว | ส่งคำสั่งการเคลื่อนที่แบบเส้นตรง TCP | `ip`: IP หุ่นยนต์, `pose`: ตำแหน่ง TCP, `a/v/t/r`: พารามิเตอร์การเคลื่อนไหว |  
| fnPhKVsDYRrB_Cf1wlsitI         | การควบคุมการเคลื่อนไหว | การเคลื่อนที่แบบเส้นตรงแกน X     | `ip`: IP หุ่นยนต์, `distance`: ระยะทาง (เมตร) |  
| fO55CY6Jw_iASo5NkxTm3l         | การควบคุมการเคลื่อนไหว | การเคลื่อนที่แบบเส้นตรงแกน Y     | `ip`: IP หุ่นยนต์, `distance`: ระยะทาง (เมตร) |  
| fs3ppclCfK_x0ZzFaOKHMk         | การควบคุมการเคลื่อนไหว | การเคลื่อนที่แบบเส้นตรงแกน Z     | `ip`: IP หุ่นยนต์, `distance`: ระยะทาง (เมตร) |  
| f18oyor3ddLJHMdPpyer45         | การควบคุมโปรแกรม   | โหลดโปรแกรม UR                   | `ip`: IP หุ่นยนต์, `program_name`: ชื่อโปรแกรม |  
| fQyW6AYZjmMiGL0unOVK0W         | การควบคุมโปรแกรม   | โหลดและรันโปรแกรม UR             | `ip`: IP หุ่นยนต์, `program_name`: ชื่อโปรแกรม |  
| fDxcON3qGCkzR5n9jSS5vQ         | การควบคุมโปรแกรม   | หยุดโปรแกรมปัจจุบัน              | `ip`: IP หุ่นยนต์  |  
| fXB2Q94gpe30w1JHgZh_yr         | การควบคุมโปรแกรม   | ระงับโปรแกรมปัจจุบันชั่วคราว      | `ip`: IP หุ่นยนต์  |  
| fyXhJEun99j0N-5ojAzPYu         | การตรวจสอบสถานะ    | รับแรงดันไฟฟ้าปัจจุบัน           | `ip`: IP หุ่นยนต์  |  
| fYvUCtj-7VJIdbm1FA6cg8         | การตรวจสอบสถานะ    | รับกระแสไฟฟ้าปัจจุบัน            | `ip`: IP หุ่นยนต์  |  
| fno_OQmW5X_c3HK8M3r_NV         | การตรวจสอบสถานะ    | รับแรงดันไฟฟ้าขอต่อ               | `ip`: IP หุ่นยนต์  |  
| fPc54VdscRk2hmlEc3VwYg         | การตรวจสอบสถานะ    | รับกระแสไฟฟ้าข้อต่อ              | `ip`: IP หุ่นยนต์  |  
| fAKuhJVkwgI4NbTKQ-xsoM         | การตรวจสอบสถานะ    | รับอุณหภูมิข้อต่อ                 | `ip`: IP หุ่นยนต์  |  
| fjZheWqG9gz8SO78UgN6v7         | การตรวจสอบสถานะ    | รับสถานะการทำงาน                  | `ip`: IP หุ่นยนต์  |  
| f2XEU4pWT2dsXI2rMsGfEw         | การตรวจสอบสถานะ    | รับสถานะการทำงานโปรแกรม           | `ip`: IP หุ่นยนต์  |  
| fYLTKblGKQserA-ZvLXCAt         | ข้อมูลอุปกรณ์      | รับเวอร์ชันซอฟต์แวร์              | `ip`: IP หุ่นยนต์  |  
| f2ebXFoN8bP3Pm1zocshdN         | ข้อมูลอุปกรณ์      | รับโหมดความปลอดภัย                | `ip`: IP หุ่นยนต์  |  
| f_5wAr6iv97d1jurrEmhNp         | การควบคุมโปรแกรม   | ส่งโปรแกรมสคริปต์                 | `ip`: IP หุ่นยนต์, `script`: เนื้อหาสคริปต์ |  
| fI3ZhZJZafBt33eNGD0ydQ         | การควบคุมการเคลื่อนไหว | การเคลื่อนที่แบบวงกลม            | `ip`: IP หุ่นยนต์, `center`: ตำแหน่ง TCP ศูนย์กลาง, `r`: รัศมี (เมตร), `coordinate`: ประเภทระนาบ |  
