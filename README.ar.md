...
| معرف الأداة (nUR_MCP_SERVER) | الفئة             | الوصف                          | المعلمات          |  
|------------------------------|------------------|--------------------------------|--------------------|  
| ffWzqSZlUpjFfVITKvBb-b       | إدارة الاتصال     | الاتصال بروبوت UR              | `ip`: IP الروبوت  |  
| fx5l9Mb_BUs_hClarGKZIo       | إدارة الاتصال     | قطع الاتصال بروبوت UR          | `ip`: IP الروبوت  |  
| f04vj-Fwbuo8s2oYu252pR       | مراقبة الحالة     | الحصول على مدة تشغيل الروبوت   | `ip`: IP الروبوت  |  
| f2SHZtIYF_OhS8LuslKt8D       | عمليات السجل      | قراءة قيمة سجل Int (0-23)      | `ip`: IP الروبوت, `index`: فهرس السجل (0-23) |  
| fjLf_89qRxYDlEKo_oXADQ       | عمليات السجل      | قراءة قيمة سجل Double (0-23)   | `ip`: IP الروبوت, `index`: فهرس السجل (0-23) |  
| f9uXSEQB1UZMXmgIyPtVH9       | عمليات السجل      | قراءة قيمة سجل Double (0-31)   | `ip`: IP الروبوت, `index`: فهرس السجل (0-31) |  
| fBHQbdS9p_BPv97XBAau8a       | معلومات الجهاز    | الحصول على الرقم التسلسلي للروبوت | `ip`: IP الروبوت  |  
| fcHIfX-J83SvH0V6XZ59A7       | تحكم الحركة       | الحصول على إحداثيات TCP في الوقت الفعلي | `ip`: IP الروبوت  |  
| fwloSfxAGiC_4rjdaZjUng       | تحكم الحركة       | الحصول على زوايا المفاصل في الوقت الفعلي | `ip`: IP الروبوت  |  
| fFg2TP6jf3XTWytLIf9fyO       | تحكم الحركة       | إرسال أمر وضع المفصل           | `ip`: IP الروبوت, `q`: زوايا المفاصل (راديان), `a/v/t/r`: معلمات الحركة |  
| fBevTU5BWNdVNEKgqLV5d1       | تحكم الحركة       | إرسال أمر حركة خطية لـ TCP      | `ip`: IP الروبوت, `pose`: موضع TCP, `a/v/t/r`: معلمات الحركة |  
| fnPhKVsDYRrB_Cf1wlsitI       | تحكم الحركة       | حركة خطية على المحور X          | `ip`: IP الروبوت, `distance`: مسافة الحركة (أمتار) |  
| fO55CY6Jw_iASo5NkxTm3l       | تحكم الحركة       | حركة خطية على المحور Y          | `ip`: IP الروبوت, `distance`: مسافة الحركة (أمتار) |  
| fs3ppclCfK_x0ZzFaOKHMk       | تحكم الحركة       | حركة خطية على المحور Z          | `ip`: IP الروبوت, `distance`: مسافة الحركة (أمتار) |  
| f18oyor3ddLJHMdPpyer45       | تحكم البرنامج     | تحميل برنامج UR                 | `ip`: IP الروبوت, `program_name`: اسم البرنامج |  
| fQyW6AYZjmMiGL0unOVK0W       | تحكم البرنامج     | تحميل وتنفيذ برنامج UR          | `ip`: IP الروبوت, `program_name`: اسم البرنامج |  
| fDxcON3qGCkzR5n9jSS5vQ       | تحكم البرنامج     | إيقاف البرنامج الحالي           | `ip`: IP الروبوت  |  
| fXB2Q94gpe30w1JHgZh_yr       | تحكم البرنامج     | إيقاف البرنامج الحالي مؤقتًا    | `ip`: IP الروبوت  |  
| fyXhJEun99j0N-5ojAzPYu       | مراقبة الحالة     | الحصول على الجهد الحالي         | `ip`: IP الروبوت  |  
| fYvUCtj-7VJIdbm1FA6cg8       | مراقبة الحالة     | الحصول على التيار الحالي        | `ip`: IP الروبوت  |  
| fno_OQmW5X_c3HK8M3r_NV       | مراقبة الحالة     | الحصول على جهد المفاصل          | `ip`: IP الروبوت  |  
| fPc54VdscRk2hmlEc3VwYg       | مراقبة الحالة     | الحصول على تيار المفاصل         | `ip`: IP الروبوت  |  
| fAKuhJVkwgI4NbTKQ-xsoM       | مراقبة الحالة     | الحصول على درجة حرارة المفاصل   | `ip`: IP الروبوت  |  
| fjZheWqG9gz8SO78UgN6v7       | مراقبة الحالة     | الحصول على حالة التشغيل         | `ip`: IP الروبوت  |  
| f2XEU4pWT2dsXI2rMsGfEw       | مراقبة الحالة     | الحصول على حالة تنفيذ البرنامج  | `ip`: IP الروبوت  |  
| fYLTKblGKQserA-ZvLXCAt       | معلومات الجهاز    | الحصول على إصدار البرنامج       | `ip`: IP الروبوت  |  
| f2ebXFoN8bP3Pm1zocshdN       | معلومات الجهاز    | الحصول على وضع الأمان           | `ip`: IP الروبوت  |  
| f_5wAr6iv97d1jurrEmhNp       | تحكم البرنامج     | إرسال برنامج نصي                | `ip`: IP الروبوت, `script`: محتوى النص |  
| fI3ZhZJZafBt33eNGD0ydQ       | تحكم الحركة       | حركة دائرية                     | `ip`: IP الروبوت, `center`: موضع TCP المركزي, `r`: نصف القطر (أمتار), `coordinate`: نوع المستوى |  
